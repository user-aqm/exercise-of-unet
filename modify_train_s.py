...
from util.testNet_s import UNet
...
"""
    加载模型及获取上次训练的loss值
"""
model_path= "model/test_s_loss_0.025045.pth"
...
#             if name_loss <= n_loss:     #compare and  save the miniamun modell
#                 n_loss=name_loss
#                 fileName = f"model/test_s_loss_{n_loss:.6f}.pth"
...
#
#
# fileName = f"TrainData/TD_test_s_loss_{n_loss:.6f}.txt"
